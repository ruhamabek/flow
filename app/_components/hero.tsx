      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 py-16">
        <div className="w-full max-w-4xl mx-auto flex flex-col items-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full max-w-md mx-auto">
             ...
             {isNewUser && (
              <Link href="/setup">
                <Button className="rounded-full bg-blue-600 hover:bg-blue-700 text-white h-12 w-full sm:w-auto">
                  Claim 100 Credits
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-16 w-full">
            {[
              { title: "Smart Scraping", description: "Extract structured data from websites" },
              { title: "Data Management", description: "Organize, clean, and store data instantly" },
              { title: "Integrations", description: "Easily connect with APIs, dashboards, or external databases." },
            ].map((feature, index) => (
              <div
                key={index}
